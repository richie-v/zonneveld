	...
	class sw_resp_page_listing extends WP_Widget {
		...
		**/
		function RP_Shortcode( $atts, $content = null ){
			...
			ob_start();		
			if( $layout == 'default' ){
				include( sw_core_override_check( 'sw-page', 'default' ) );
			}	
			if( $layout == 'layout1' ){
				include( sw_core_override_check( 'sw-page', 'layout1' ) );
			}	
		...
		public function widget( $args, $instance ) {
			...
			if ( $tpl = $tpl = sw_core_override_check( 'sw-page', $instance['widget_template'] ) ){ 
