		...
		$(window).on( "load", function(){
			...
			$(document).ready(function(){ 
				...
				$("#countdown-container").ClassyCountdown({
					...
					labelsOptions: {
						lang: {
						days: "'. esc_html__( 'Days', 'autusin' ) .'",
						hours: "'. esc_html__( 'Hours', 'autusin' ) .'",
						minutes: "'. esc_html__( 'Mins', 'autusin' ) .'",
						seconds: "'. esc_html__( 'Secs', 'autusin' ) .'"
						},
