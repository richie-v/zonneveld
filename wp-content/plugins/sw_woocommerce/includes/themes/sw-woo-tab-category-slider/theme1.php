									...
									<div class="container">
										<div class="row">
											<div class="item-left col-lg-4 col-md-4 col-sm-4">
												<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail( 'autusin_shop-image' ); ?></a>
											</div>
											...
											<div class="item-right col-lg-4 col-md-4 col-sm-4">
												<a class="read-more" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail( 'autusin_shop-image' ); ?></a>
											</div>
										</div>
									</div>
								</div>
