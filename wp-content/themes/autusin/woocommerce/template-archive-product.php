...
<div class="container">
	...
	<!-- Left Sidebar -->
	<?php 	
	if ( is_active_sidebar('left-product') && autusin_sidebar_product() != 'right' && autusin_sidebar_product() != 'full' ):
	...
	<div id="contents" <?php autusin_content_product(); ?> role="main">
		<?php
			/**
	...
	<!-- Right Sidebar -->
	<?php if ( is_active_sidebar('right-product') && autusin_sidebar_product() != 'left' && autusin_sidebar_product() != 'full' ):
