...
$autusin_single_thunbmail = ( sw_options( 'product_single_thumbnail' ) && !autusin_mobile_check() ) ? sw_options( 'product_single_thumbnail' ) : 'bottom';
$post_thumbnail_id	 	  = get_post_thumbnail_id( $post->ID );
?>
<div id="product_img_<?php echo esc_attr( $post->ID ); ?>" class="woocommerce-product-gallery woocommerce-product-gallery--with-images images product-images loading" data-vertical="<?php echo ( ( $autusin_single_thunbmail == 'left' || $autusin_single_thunbmail == 'right' ) && !autusin_mobile_check() ) ? 'true' : 'false'; ?>" data-video="<?php echo sprintf( ( $autusin_featured_video != '' ) ? '%s' : '', esc_url( 'https://www.youtube.com/embed/' . $autusin_featured_video ) ); ?>">
	<figure class="woocommerce-product-gallery__wrapper">
	<div class="product-images-container clearfix <?php echo esc_attr( 'thumbnail-' . $autusin_single_thunbmail ); ?>">
		<?php 
